...
urlpatterns = [
    ...
    path('listings/<int:pk>/', listings_views.ListingDetail.as_view()),
    path('listings/<int:pk>/delete/', listings_views.ListingDelete.as_view()),
    path('listings/<int:pk>/update/', listings_views.ListingUpdate.as_view()),
